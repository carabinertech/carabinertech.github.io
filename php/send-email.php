<?php	
	// Your Email
	$recipient = "info@carabinertech.com"; // PLEASE SET YOUR EMAIL ADDRESS
	$recaptcha_secret_key = '6LcHlUUUAAAAAFylLkWP27vbY2exSiXa-IwqoJ_E'; // PLEASE SET YOUR GOOGLE RECAPTCHA API KEY.
